//Variável que controla a rodada
var rodada = 1
...
$(document).ready(function(){
    $('#btn_iniciar_jogo').click(function(){
        //valida a inserção dos apelidos dos jogadores
        ...
        //exibir os apelidos nos avatares
        $('#nome_jogador_1').html($('#entrada_apelido_jogador_1').val())
        $('#nome_jogador_2').html($('#entrada_apelido_jogador_2').val())
        // ocultar e exibir o menu inicial e o ambiente de jogo
        $('#pagina_inicial').hide()
        $('#palco_jogo').show()
    })
    //captura dos cliques das jogadas
    $('.jogada').click(function(){
        //captura para controlar cada id independentemente
    ...
    function jogada(id){
        ...
        //recuperação dos pontos da jogada para realizar a soma
